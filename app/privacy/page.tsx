...
const sections = [
    ...
    },
    {
        ...
        body: [
            "activeTab, tabs, scripting 권한: 사용자가 선택한 나이스 화면에서 입력 보조 스크립트를 실행하기 위해 사용합니다.",
            ...
            "host permissions: 브리지 화면과 나이스 입력 화면에서 확장 기능을 실행하기 위해 사용합니다. 실제 입력 동작은 사용자의 명시적인 버튼 클릭 이후 수행됩니다.",
        ],
    },
    {
        title: "5. 학생 정보 처리 원칙",
