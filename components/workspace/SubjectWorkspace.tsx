...
export const SubjectWorkspace = ({
    ...
    return (
        <Card className={cn(
            ...
            isExpanded ? "fixed inset-4 z-[300] rounded-[3rem] border border-indigo-100 shadow-primary/20 overflow-hidden flex flex-col" : "rounded-[3rem] overflow-hidden"
        )}>
            {/* Header Section */}
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Popover open={isBulkOpen} onOpenChange={setIsBulkOpen}>
                        ...
                        <PopoverContent className="w-40 p-2 rounded-2xl shadow-xl border-indigo-100" align="end">
