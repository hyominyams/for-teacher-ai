    ...
    return (
        <Card className={cn(
            ...
            <div className="space-y-4">
                <div className="grid grid-cols-[40px_80px_minmax(250px,1fr)_minmax(300px,2fr)_160px] gap-8 px-8 py-5 bg-slate-50 rounded-2xl border border-slate-100 text-xs font-black uppercase tracking-[0.1em] text-slate-400 items-center">
